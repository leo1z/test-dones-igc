...
*   [x] **Jerarquía y Ámbito de Filtros en Panel Admin (`admin.html`):**
    *   **Orden Pastoral de Secciones:** Se posicionó la **Sección de Estadísticas de la Encuesta de Evaluación** como Sección #5 (inmediatamente después de las 5 Tarjetas de Métricas de Dones), respondiendo a los Filtros Globales de Fecha y Zona.
    *   **Aviso de Filtros Autónomos:** La sección *"Análisis Global de los 15 Dones Espirituales"* se posicionó como Sección #6 con una caja destacada de aviso (*"💡 Aviso de Filtros Autónomos: Esta sección funciona como una herramienta de exploración independiente. Las métricas de esta gráfica son controladas exclusivamente por sus propios filtros internos y no son afectadas por el filtro global de zona superior."*).
