...
*   [x] **Favicon Oficial `favicon_igc.png` (`index.html`, `admin.html`):** Copiado el archivo exacto desde `docs/design/logos/favicon_igc.png` a `src/assets/logos/favicon_igc.png` y configurado como favicon e icono táctil oficial en todas las páginas.
