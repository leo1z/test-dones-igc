...
*   [x] **Favicon de Regalo Vectorial SVG (`index.html`, `admin.html`):** Creado un icono vectorial limpio de caja de regalo con listón dorado (`src/assets/icons/favicon-gift.svg`) y configurado como favicon SVG (`type="image/svg+xml"`) e icono táctil en todas las páginas.
