...
*   [x] **Favicon Oficial `favicon_igc.png` con Proporciones Originales Preservadas (`index.html`, `admin.html`):** Convertida la imagen `favicon_igc.png` a un lienzo cuadrado 1:1 (500×500 px con relleno transparente), permitiendo que la pestaña del navegador mantenga las proporciones exactas del logo original sin estiramientos ni distorsiones.
