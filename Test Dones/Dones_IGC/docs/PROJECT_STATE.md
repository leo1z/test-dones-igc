...
*   [x] **Favicon Oficial `favicon_igc.png` (`index.html`, `admin.html`):** Configurado el logo emblemático `src/assets/logos/favicon_igc.png` como el favicon principal y accesos directos táctiles en todas las páginas de la plataforma.
