...
*   [x] **Alineación Perfecta del Ícono en Botón 'Conectar con Grupo':** Aplicado `white-space: nowrap; font-size: 0.88rem;` y flex centrado para que el ícono y el texto permanezcan **100% alineados y centrados juntos en una sola línea**, solucionando el problema de salto de línea e ícono desalineado a la izquierda.
