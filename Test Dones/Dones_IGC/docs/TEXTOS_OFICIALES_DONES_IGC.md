# Documento de Copys y Textos Oficiales — Dones IGC (v3)

Este documento contiene la totalidad de los textos de la Web App **Dones IGC**, organizados por secciones para revisión editorial, pastoral y corrección de estilo.
...
2. **Test**
3. **Dones**
4. **Resultados** *(Visitable tras finalizar el test)*
...
* **Pregunta 1:** `1. ¿Asistes actualmente a un Grupo de Crecimiento?`
  * Opciones: `[Sí asisto]` | `[No asisto]`
* **Pregunta 2:** `2. ¿En qué Zona / Ciudad de Honduras vives?`
  * Opciones del selector:
    ...
    - *Otro departamento de Honduras*
    - *Resido fuera de Honduras*
* **Botón de Confirmación:** `Entrar a la aplicación`

---

## 3. 🏠 Pantalla de Inicio (Home)

* **Título de Marca:** `DONES ESPIRITUALES`
* **Subtítulo:** `Otro de los regalos de la Gracia de Dios`
* **Botón Principal 1:** `Aprender` *(Abre la sección de Glosario)*
* **Botón Principal 2:** `Descubrir` *(Inicia el Test de Dones)*
...
* **Episodios:**
  - `▶ Parte 1: Los Dones de Gracia` — *[Ver Video →]* *(Enlace: https://www.youtube.com/watch?v=SnUkqFxukyk&t=180s)*
  - `▶ Parte 2: Descubriendo tu Don` — *[Pendiente]*
...
* **Pregunta 2:** `2. ¿Sientes que los resultados reflejan tu manera de ayudar a otros, especialmente a hermanos en la fe?` *(Botones de opción única: Sí / Parcialmente / No)*
...
* **Opción B (Si el usuario marcó SÍ asistir a grupo):**
  - Texto: `¡Sigue ejerciendo activamente tus dones en tu Grupo de Crecimiento!`
  - Botón: `Entendido`
...
* **Ejemplos Prácticos de Servicio:**
  - Liderar jornadas o cadenas de oración por causas complejas de la iglesia.
  - Animar con convicción y Escritura a hermanos que están atravesando crisis extremas.
...
* **Ejemplos Prácticos de Servicio:**
  - Preparar el templo, sonido, sillas y parqueo antes de los servicios dominicales.
  - Colaborar en la cocina o montaje de eventos de la iglesia con alegría.
...
* **Ejemplos Prácticos de Servicio:**
  - Visitar a enfermos en hospitales o ancianos en sus hogares para brindarles compañía.
  - Acompañar a familias en procesos de duelo o pérdidas emocionales profundas.
...
* **Ejemplos Prácticos de Servicio:**
  - Acompañar en consejería bíblica a hermanos que luchan con malos hábitos o estancamiento.
  - Guiar a un creyente descarriado de vuelta al arrepentimiento y la comunión.
...
* **Ejemplos Prácticos de Servicio:**
  - Liderar y cuidar a un grupo de conexión o célula de forma personalizada.
  - Hacer llamadas de seguimiento y visitas a quienes han faltado a las reuniones.
...
* **Ejemplos Prácticos de Servicio:**
  - Elaborar presupuestos, cronogramas y listas de verificación para eventos grandes.
...
* **Ejemplos Prácticos de Servicio:**
  - Evaluar libros, predicaciones o doctrinas en tendencia para advertir a la congregación.
  - Percibir intenciones o actitudes sutiles en conversaciones de consejería para guiar con prudencia.
...
## 9. 🛡️ Panel de Administración (`admin.html`)

* **Título de Login:** `Panel Admin — Dones IGC`
* **Instrucción:** `Ingresa la clave de acceso autorizada para consultar estadísticas pastorales.`
* **Error Login:** `Clave incorrecta. Inténtalo de nuevo.`
* **Header Admin:** `Estadísticas de Dones IGC — Panel de Gestión Pastoral`
* **Filtros de Fecha:** `Desde:` | `Hasta:` | `[Filtrar Rango]` | `[Limpiar Filtros]`
* **Tarjetas de Métricas:**
  1. `Total de Evaluaciones` — *Respuestas registradas*
  2. `Asistencia a Grupos` — *Asisten a Grupo de Crecimiento*
  3. `Claridad Promedio` — *Evaluación de la experiencia*
  4. `Precisión Percibida` — *Sienten que refleja sus vivencias*
* **Secciones de Gráficos:**
  - `📍 Distribución por Zona / Ciudad`
  - `🔥 Dones Principales Más Frecuentes`
* **Tabla de Comentarios:**
  - `💬 Comentarios y Sugerencias Abiertas`
  - Columnas: `Fecha y Hora` | `Zona` | `Claridad` | `Precisión` | `Comentario / Sugerencia`
